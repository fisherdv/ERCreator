    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=256)),
                ('comment', models.CharField(blank=True, max_length=256, null=True)),
                ('entities', models.ManyToManyField(blank=True, to='api.Entity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_key', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.attribute')),
